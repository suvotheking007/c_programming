...
/*
    ...
    v2 ---------------------------
        This gives more accurate and precise results using double data type
...
int main()
{
    float a, b, c, s_p, area, under_sqrt;
    ...
    //Calculating the value which goes under square root
    under_sqrt = (s_p*(s_p-a)*(s_p-b)*(s_p-c));

    //Calculation of the area ;
    area = pow(under_sqrt,-2) ;
